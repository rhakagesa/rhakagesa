...
function ContactForm() {
  ...
  return (
    ...
    >
      <label
        htmlFor="name"
        className="w-full relative block overflow-hidden rounded-md border border-gray-200 px-3 pt-3 shadow-xs focus-within:border-gray-400 focus-within:ring-1 focus-within:ring-gray-400"
      >
        <input
          type="text"
          id="name"
          name="name"
          placeholder="Name"
          className="peer h-8 w-full border-none bg-transparent p-0 placeholder-transparent focus:border-transparent focus:outline-hidden focus:ring-0 sm:text-base"
        />
      ...
      >
        <textarea
          ...
          name="message"
          placeholder="Message"
          className="peer h-52 pt-2 w-full border-none bg-transparent p-0 placeholder-transparent focus:border-transparent focus:outline-hidden focus:ring-0 sm:text-base"
        />
