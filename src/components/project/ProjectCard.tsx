...
function ProjectCard({data}: {data: ProjectData[]}) {
    return(
        ...
        <a href={item.link} target="_blank">
            <div key={index}  className="group hover:animate-background rounded-xl bg-gradient-to-r from-gray-300 via-gray-500 to-gray-600 p-0.5 shadow-xl transition hover:bg-[length:400%_400%] hover:shadow-sm hover:[animation-hover:_4s]">
            <div className="flex flex-col rounded-lg bg-white p-4 sm:p-6">
                    ...
                    <p className="truncate group-hover:w-full group-hover:h-full mt-2 text-gray-700 text-justify leading-relaxed">{item.desc}</p>
