          ...
          <div className="flex flex-col gap-2" key={index}>
            ...
            >
              ...
              <div className="flex flex-col w-5/6">
                ...
                <p className="text-sm sm:text-base text-gray-700 font-semibold flex items-center">
              ...
              <svg
                className={`size-5 w-1/12 ${buttonExpand(index)}`}
            ...
            <ul
              className={`${expandEffect(
                index
              )} text-sm sm:text-base text-gray-700 list-disc list-inside`}
            >
              {item.credentials && <p>Module that have been learned :</p>}
            ...
            {item.link && (
              ...
              >
                ...
                <span className="text-xs sm:text-sm font-semibold transition-all group-hover:me-4">
                  {" "}
                  Details{" "}
                </span>
              </a>
